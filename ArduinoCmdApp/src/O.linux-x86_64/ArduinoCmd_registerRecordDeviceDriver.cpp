...
/* Generated from ../O.Common/ArduinoCmd.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_asynInt64TimeSeries, *pvar_dset_devwaveformStream;
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "asynAiInt64", "devaiStream",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32",
    "asynAoFloat64", "asynAoInt64", "devaoStream", "asynRecordDevice",
    ...
    "asynLiInt64", "devlonginStream", "devLoSoft", "devLoSoftCallback",
    "asynLoInt32", "asynLoUInt32Digital", "asynLoInt64",
    "devlongoutStream", "devLsiSoft", "devLsiEnviron",
    ...
    "devPrintfStdio", "asynPfOctetWrite", "devSiSoft",
    "devSiSoftCallback", "devTimestampSI", "devSiGeneralTime",
    "devSiEnviron", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devstringinStream", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "asynSoOctetWrite",
    ...
    "asynInt64TimeSeries", "devwaveformStream"
};
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_rsrvRegistrar,
...
int ArduinoCmd_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/mix3/modules/stream/ArduinoCmd";
...
/* ArduinoCmd_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ArduinoCmd_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(ArduinoCmd_registerRecordDeviceDriver(*iocshPpdbbase));
}
